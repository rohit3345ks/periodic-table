...
void explor()
{
	...
	mainscreen();
	label6:
	gotoxy(22,12);textcolor(12);
	cprintf("Enter the corresponding no");gotoxy(22,14);textcolor(3);
	cprintf("1.Search by 'NAME'");gotoxy(22,16);
	cprintf("2.Search by SYMBOL");gotoxy(22,18);
	cprintf("3.Search by ATOMIC NUMBER");gotoxy(22,20);
	cprintf("4.Search by ATOMIC WEIGHT");gotoxy(22,22);
	cprintf("5 Elements of Diff. Blocks");gotoxy(22,24);
